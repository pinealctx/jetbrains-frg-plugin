...
public class FrgDocMetadataImpl extends ASTWrapperPsiElement implements FrgDocMetadata {

  public FrgDocMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FrgVisitor visitor) {
    visitor.visitDocMetadata(this);
  }
