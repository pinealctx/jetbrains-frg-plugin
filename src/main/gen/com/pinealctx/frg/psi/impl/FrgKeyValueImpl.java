...
public class FrgKeyValueImpl extends ASTWrapperPsiElement implements FrgKeyValue {

  public FrgKeyValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FrgValue getValue() {
    return findNotNullChildByClass(FrgValue.class);
  }
