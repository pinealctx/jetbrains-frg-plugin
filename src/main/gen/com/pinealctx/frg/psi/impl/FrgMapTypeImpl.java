...
public class FrgMapTypeImpl extends ASTWrapperPsiElement implements FrgMapType {

  public FrgMapTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FrgPrimitiveType getPrimitiveType() {
    return findNotNullChildByClass(FrgPrimitiveType.class);
  }
