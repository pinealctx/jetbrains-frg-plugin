...
public class FrgHandlerMetadataImpl extends ASTWrapperPsiElement implements FrgHandlerMetadata {

  public FrgHandlerMetadataImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FrgVisitor visitor) {
    visitor.visitHandlerMetadata(this);
  }
