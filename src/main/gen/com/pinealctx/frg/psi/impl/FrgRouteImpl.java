...
public class FrgRouteImpl extends ASTWrapperPsiElement implements FrgRoute {

  public FrgRouteImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public FrgRoutePath getRoutePath() {
    return findNotNullChildByClass(FrgRoutePath.class);
  }
