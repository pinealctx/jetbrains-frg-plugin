...
public class FrgAnonymousFieldImpl extends ASTWrapperPsiElement implements FrgAnonymousField {

  public FrgAnonymousFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FrgVisitor visitor) {
    visitor.visitAnonymousField(this);
  }
