...
public class FrgTypeDeclImpl extends FrgNamedElementImpl implements FrgTypeDecl {

  public FrgTypeDeclImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<FrgTypeField> getTypeFieldList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, FrgTypeField.class);
  }
