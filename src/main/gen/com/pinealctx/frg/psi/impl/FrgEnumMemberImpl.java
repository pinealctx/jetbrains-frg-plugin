...
public class FrgEnumMemberImpl extends ASTWrapperPsiElement implements FrgEnumMember {

  public FrgEnumMemberImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  public FrgValue getValue() {
    return findChildByClass(FrgValue.class);
  }
