...
public class FrgExternDefImpl extends ASTWrapperPsiElement implements FrgExternDef {

  public FrgExternDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull FrgVisitor visitor) {
    visitor.visitExternDef(this);
  }
